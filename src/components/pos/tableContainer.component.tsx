    ...
    <div className="w-full h-screen ">
      ...
      <div className="w-full h-16 flex items-center border-b border-gray-200 ">
        <div className="flex justify-between items-center w-full px-2 md:px-1 lg:px-5">
          ...
          <Button size="icon" className="h-10 w-10 bg-primary rounded-xl md:hidden" onClick={handleScale}>
        ...
        <div className="bg-background  max-h-[220px]">
          <Table>
            <TableFooter>
              ...
              <TableRow>
                <TableCell colSpan={2}>Discount 15%</TableCell>
                <TableCell className="text-right">${200}</TableCell>
                <TableCell></TableCell>
              </TableRow>
              <TableRow>
                <TableCell colSpan={2}>Vat 15%</TableCell>
                <TableCell className="text-right">${200}</TableCell>
                <TableCell></TableCell>
              </TableRow>
              <TableRow>
